...
export const DESIGN_NOT_FOUND = "Design not found";
...
export const INSTANCE_ID_MISSING = "Missing instance ID";
export const INSTANCE_NAME_FOUND = "Found instance with same name";
